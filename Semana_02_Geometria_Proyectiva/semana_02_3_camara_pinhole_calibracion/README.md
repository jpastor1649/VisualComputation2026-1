...
- ✅ Carpeta con nombre `semana_02_3_camara_pinhole_calibracion`
- ✅ Código Python limpio y funcional en carpeta `python/`
- ✅ Código React Three Fiber limpio y funcional en carpeta `threejs/`
- ✅ Imágenes y GIFs en carpeta `media/` con referencias en README
- ✅ Mínimo 2 resultados visuales por implementación (4 visuales en total)
- ✅ Código relevante documentado con ejemplos
- ✅ Prompts de IA documentados
- ✅ Aprendizajes y dificultades explicados
- ✅ Implementación correcta del modelo pinhole
- ✅ Calibración exitosa documentada
- ✅ Distorsión visible y efectiva
